...
import com.cs.nks.easycouriers.activity.ProjectPhotoDetailActivity;
...
public class Course_List_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle(UTIL.getTitle("Course List"));
    ...
    public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position) {
            ...
            if (mail == null || mail.trim().equals("")) {
                ...
                holder.tv_status.setText(mail+" month(s)");
            ...
            holder.parentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("c_id", CentreName);
